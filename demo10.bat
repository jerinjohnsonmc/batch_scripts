:: batch file to demonstrate logging 
:: By: JJ on 16OCT24
...
echo This batch file will list and move all the text files in a directory its run from, to an output directory, with logging
echo "*******************************************"
for %%a in (*.txt) do  echo %%a will be moved
:: lists all the text files
echo starts moving files at %DATE% %TIME% >> filemove.log
:: starts logging
copy "*.txt" "%~dp0output\" >> filemove.log
...
echo end moving files at %DATE% %TIME% >> filemove.log
::ends logging
